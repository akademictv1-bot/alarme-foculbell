...
export default function CancelReasonModal({ taskTitle, onSaveReason, onDismiss }: CancelReasonModalProps) {
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.bg }]}>
      <View style={styles.content}>
        ...
        <Text style={[styles.title, { color: colors.text }]}>{$('taskNotCompleted')}</Text>
        ...
        <View style={styles.buttons}>
          ...
          <Pressable onPress={() => onSaveReason(reason.trim())} style={[styles.saveBtn, { backgroundColor: colors.warning }]}>
            <Text style={[styles.saveBtnText, { color: '#fff' }]}>{$('saveReason')}</Text>
          </Pressable>
        </View>
      </View>
    </View>
